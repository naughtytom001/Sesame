package io.github.naughtytom001.sesame.model.extensions;
...
import io.github.naughtytom001.sesame.model.task.antSports.AntSportsRpcCall;
import io.github.naughtytom001.sesame.model.task.protectEcology.ProtectTreeRpcCall;
...
public class ExtensionsHandle {
    ...
    public static Object handleAlphaRequest(String type, String fun, Object data) {
        try {
            return Class.forName("io.github.naughtytom001.sesame.model.extensions.ExtensionsHandleAlpha")
