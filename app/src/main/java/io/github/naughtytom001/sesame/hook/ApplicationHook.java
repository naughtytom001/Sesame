package io.github.naughtytom001.sesame.hook;
...
import io.github.naughtytom001.sesame.data.RunType;
import io.github.naughtytom001.sesame.data.TokenConfig;
import io.github.naughtytom001.sesame.data.ViewAppInfo;
import io.github.naughtytom001.sesame.data.task.BaseTask;
import io.github.naughtytom001.sesame.data.task.ModelTask;
import io.github.naughtytom001.sesame.entity.AlipayVersion;
...
import io.github.naughtytom001.sesame.model.extensions.TestRpc;
import io.github.naughtytom001.sesame.model.normal.base.BaseModel;
import io.github.naughtytom001.sesame.model.task.antMember.AntMemberRpcCall;
import io.github.naughtytom001.sesame.rpc.bridge.NewRpcBridge;
import io.github.naughtytom001.sesame.rpc.bridge.OldRpcBridge;
import io.github.naughtytom001.sesame.rpc.bridge.RpcBridge;
import io.github.naughtytom001.sesame.rpc.bridge.RpcVersion;
import io.github.naughtytom001.sesame.rpc.intervallimit.RpcIntervalLimit;
import io.github.naughtytom001.sesame.util.ClassUtil;
import io.github.naughtytom001.sesame.util.FileUtil;
import io.github.naughtytom001.sesame.util.LibraryUtil;
import io.github.naughtytom001.sesame.util.Log;
import io.github.naughtytom001.sesame.util.NotificationUtil;
import io.github.naughtytom001.sesame.util.PermissionUtil;
            ...
            if (action != null) {
                switch (action) {
                    ...
                    case "com.eg.android.AlipayGphone.sesame.status":
                        try {
                            context.sendBroadcast(new Intent("io.github.naughtytom001.sesame.status"));
                        } catch (Throwable th) {
