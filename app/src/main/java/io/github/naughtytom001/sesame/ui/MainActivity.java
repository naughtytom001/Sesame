...
import io.github.naughtytom001.sesame.entity.UserEntity;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action != null) {
                    switch (action) {
                        case "io.github.naughtytom001.sesame.status":
                            ...
                            break;
                        case "io.github.naughtytom001.sesame.update":
                            Statistics.load();
        ...
        intentFilter.addAction("io.github.naughtytom001.sesame.status");
        intentFilter.addAction("io.github.naughtytom001.sesame.update");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forest_log) {
            ...
            data = "https://github.com/naughtytom001/Sesame";
